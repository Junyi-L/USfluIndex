...
The last four seasons are taken as testing data to assess the forecast performance. 
...
Dawid-Sebastiani score \cite{dawid.sebastiani1999} and absolute error over the testing period 
