...
# S_v = 3S_{\\phi} = 3lag = 4   20 3023.495 -6006.990       1
# S_v = 3S_{\\phi} = 4lag = 4   22 3025.185 -6006.370       2
# S_v = 4S_{\\phi} = 3lag = 4   22 3023.882 -6003.763       5
# S_v = 3S_{\\phi} = 3lag = 5   21 3023.836 -6005.673       3
# S_v = 3S_{\\phi} = 4lag = 5   23 3025.504 -6005.008       4
#-------------------------------------------------------- ph1-4 forecast--------------------------------------------------
...
saveRDS(BetaRegression,
        file = paste0("./Results/Forecast_ph1-4/Beta_lag", lags, ".rds"))
