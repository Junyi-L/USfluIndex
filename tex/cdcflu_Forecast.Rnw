...
\abstract{
  ...
  consistently outperformed the equal bin reference appoach.
...
Nsoesie et al. \cite{nsoesie.etal2014} and Chretien et al. \cite{chretien.etal2014} review influenza forecasting models systematically. 
Reich et al. \cite{Reich2019}
