...
probabilistic forecasts quantify the uncertainty in a prediction and 
thus are essential for optimal decision making.
...
print_2heading_xtable(res_ph1_4,
                      ...
                      over the testing period. The "MMWR week 40 - 20" group summarizes 
                      the mean log score (LS) and the mean Dawid-Sebastiani score (DSS)
...
all predictions in the testing period. 
...
log score for all predictions in the testing period. 
